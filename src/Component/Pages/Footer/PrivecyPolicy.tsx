  ...
  return (
    <div className="bg-[#EEEEEE] changebg">
      ...
      <div className="w-[96%] md:w-[90%] mx-auto">
        ...
        When you use our contact form we will gather your name, location and
        email address. This information is used solely for the purpose of
        contacting you to inform you of services that we feel will be of
        interest to you. If you leave a comment on our site you may opt-in to
        ...
        when you leave another comment. These cookies will last for one year. If
        you have an account and you log in to this site, we will set a temporary
        ...
        your account, the login cookies will be removed. If you edit or publish
        ...
        We will not share your data with any third parties, except for Mail
        Chimp who manage our mailing list for any subscriptions such as the
        newsletter on this website.
