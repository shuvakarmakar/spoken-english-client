    ...
    <div className="bg-[#eeeeee] py-5 changebg">
      ...
      <div className="w-[96%] md:w-[90%] mx-auto">
        ...
        <div className="text-lg">
          Google, as a third party advertisement vendor, uses cookies to serve
          ads on this site. The use of DART cookies by Google enables them to
          serve adverts to visitors that are based on their visits to this
          website as well as other sites on the internet.
          <br />
          ...
          privacy policies, Basic English Speaking has no access or control over
          these cookies that may be used by third party advertisers.
        </div>
      </div>
    </div>
  );
