...
const PopularCourse = () => {
  ...
  const filterPupoularCourses=popularCourses.sort((a,b)=>b.number_of_students-a.number_of_students)
  ...
  return (
    <div className="bg-white">
      <section className="flex items-center justify-between py-5 w-[96%] md:w-[90%] mx-auto">
        ...
        <Link to={`/all-courses`} className="py-2 px-3 bg-[rgba(0,0,0,0.1)] rounded font-bold">View All</Link>
      </section>
      <section className="w-[96%] md:w-[90%] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-5">
          {filterPupoularCourses.slice(0,3).map((pc) => (
