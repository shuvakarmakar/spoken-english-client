...
const Blogs = () => {
  ...
  return (
    <div className="bg-white px-4 md:px-8 lg:px-16">
      <section className="title flex flex-col md:flex-row justify-center items-center gap-5 py-10 md:py-16">
        <div className="flex flex-col items-center justify-center md:justify-start">
          <p className="text-3xl font-bold">From</p>
          <p className="text-3xl font-bold text-left">The</p>
        </div>
        <p className="text-4xl md:text-8xl font-bold">Blogs</p>
      </section>
        ...
        <div className="w-full md:w-11/12 lg:w-9/12 mx-auto">
          {blogs.slice(0, 3).map((blog) => (
            <div key={blog._id} className="mb-8 md:mb-12 relative">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 py-5">
