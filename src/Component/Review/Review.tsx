        ...
        <div className="">
          <section className="">
            <div className="mx-auto max-w-screen-xl px-4 py-6 sm:px-6 sm:py-24 lg:px-8">
              <h2 className="text-center mb-20   text-3xl font-extrabold sm:text-5xl uppercase">
                 From <span className="text-blue-500">Student</span>
              </h2>
                ...
                <SwiperSlide>
                  ...
                  <blockquote className="rounded-lg bg-gray-100 p-8">
                    ...
                    <p className="line-clamp-2 sm:line-clamp-none mt-4 text-gray-500">
                      ...
                      aspernatur accusamus similique reprehenderit quasi a
                      tempora inventore dignissimos asperiores nostrum vitae at
                      sapiente atque! Deleniti.{" "}
                    </p>
                  </blockquote>
                </SwiperSlide>
                <SwiperSlide>
